(() => {
    ...
    const btnsFilter = document.querySelectorAll(".filters__item");
    const storeProducts = document.querySelectorAll(".product-collection");
    for (let i = 0; i < btnsFilter.length; i++) btnsFilter[i].addEventListener("click", (e => {
        e.preventDefault();
    ...
    const btnsList = document.querySelectorAll(".filters__item");
    btnsList.forEach((btnEl => {
