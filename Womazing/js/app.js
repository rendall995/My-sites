(() => {
    ...
    let formValidate = {
        ...
        validateInput(formRequiredItem) {
            ...
            if (formRequiredItem.dataset.required === "email") {
                ...
                const minLength = parseInt(formRequiredItem.dataset.minlength);
                if (formRequiredItem.value.trim().length < minLength) {
                    this.addError(formRequiredItem);
                    error++;
                } else this.removeError(formRequiredItem);
        ...
        addError(formRequiredItem) {
            ...
            if (formRequiredItem.dataset.error) formRequiredItem.parentElement.insertAdjacentHTML("beforeend", `<div class="form__error" style="color:red;">${formRequiredItem.dataset.error}</div>`);
        },
    ...
    function formQuantity() {
        const totalSumElements = document.querySelectorAll(".area-cart-span-change");
        const initialPriceElement = document.querySelector("[data-initial-price]");
        document.addEventListener("click", (function(e) {
            let targetElement = e.target;
            if (targetElement.closest("[data-quantity-plus]") || targetElement.closest("[data-quantity-minus]")) {
                ...
                const quantity = parseInt(valueElement.value);
                const initialPrice = initialPriceElement ? parseFloat(initialPriceElement.dataset.initialPrice) : 0;
                const totalSum = quantity * initialPrice;
    ...
    function initSliders() {
        if (document.querySelector(".sliders-page__right-slider")) {
            const thumbsSwiper = new core(".sliders-page__right-slider", {
                modules: [ Thumb, Parallax ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 20,
            ...
            new core(".sliders-page__left-slider", {
                modules: [ Pagination, Thumb, Parallax, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 20,
        ...
        if (document.querySelector(".swiper")) new core(".block-slider__slider", {
    ...
    const btns = document.querySelectorAll(".filters__item");
    const products = document.querySelectorAll(".product-collection");
    ...
    function filterProducts(e) {
        ...
        products.forEach((product => {
            ...
            const btnType = e.target.dataset.filter;
    ...
    const paggingList = document.querySelectorAll(".pagging__link");
    paggingList.forEach((elem => {
        elem.addEventListener("click", (() => {
            document.querySelector(".active")?.classList.remove("active");
            elem.classList.add("active");
        }));
    }));
    const sizeList = document.querySelectorAll(".size__button");
    const price = document.querySelector(".price__static");
    ...
    sizeList.forEach((elem => {
        elem.addEventListener("click", (e => {
            ...
            switch (elemText) {
              case "s":
                price.innerHTML = "200$";
                priceDiscount.innerHTML = "399$";
                break;

              case "l":
                price.innerHTML = "350$";
                priceDiscount.innerHTML = "480$";
                break;

              case "xl":
                price.innerHTML = "400$";
                priceDiscount.innerHTML = "519$";
                break;

              case "xxl":
                price.innerHTML = "500$";
                priceDiscount.innerHTML = "559$";
                break;
            }
        }));
    }));
    const colorList = document.querySelectorAll(".color__button");
    ...
    function handleInput(e) {
        ...
        function phoneMask(phone) {
            ...
            const match = cleanedPhone.match(/^(\d{0,2})(\d{0,3})(\d{0,3})(\d{0,2})(\d{0,2})/);
            let formattedPhone = "";
            if (match[1]) formattedPhone += `+38 `;
