(() => {
    ...
    const elementBody = document.querySelector(".block-shop");
    if (windowWidth <= 768) elementBody.outerHTML = `\n\t< div data - spollers="768" class="spollers" >\n\t\t<details class="spollers__item">\n\t\t\t<summary class="spollers__title">Магазин</summary>\n\t\t\t<ul class="spollers__body">\n\t\t\t\t<li class="spollers__item"><a href="" class="spollers__link">Пальто</a></li>\n\t\t\t\t<li class="spollers__item"><a href="" class="spollers__link">Свитшоты</a></li>\n\t\t\t\t<li class="spollers__item"><a href="" class="spollers__link">Кардиганы</a></li>\n\t\t\t\t<li class="spollers__item"><a href="" class="spollers__link">Толстовки</a></li>\n\t\t\t</ul>\n\t\t</details>\n</div > `;
    window["FLS"] = true;
    isWebp();
    menuInit();
    spollers();
